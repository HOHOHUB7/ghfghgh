...
local function wl(key)
    ...
    if true then
        local expired = 999999999999999999999999999999
        sign_match = nil
        ...
        DefaultTab = Window:NewTab({Title = "Default"})
        FarmTab = Window:NewTab({Title = "Farm"}) 
        ServerTab = Window:NewTab({Title = "Server & Info"})
        V4Tab = Window:NewTab({Title = "Race"})
        PlRTAB = Window:NewTab({Title = "Local Player"}) 
        WeaponTab = Window:NewTab({Title = "Weapon"}) 
        ShopTab = Window:NewTab({Title = "Shop"})
        RaidTab = Window:NewTab({Title = "Fruits & Raid"})
        if not Sea1 then 
            SeaBeastTab = Window:NewTab({Title = "Sea Beast"})
        end 
        SettingTab = Window:NewTab({Title = "Setting"})
        ...
        for i, v in next, game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(
            "GetFruits",
            game.Players.LocalPlayer.PlayerGui["Main (minimal)"].FruitShop:GetAttribute("Shop2")
        ) do
        ...
        function CheckSkillMastery()
            ...
            if MasteryWeapon and MasteryWeapon ~= "" then
                if
                 ...
                 then
                    if game.Players.LocalPlayer.PlayerGui["Main (minimal)"].Skills:FindFirstChild(MasteryWeapon) then
                        for i, v in next, game.Players.LocalPlayer.PlayerGui["Main (minimal)"].Skills[MasteryWeapon]:GetChildren(
        ...
        function checkskillDF()
            if
                not game.Players.LocalPlayer.PlayerGui["Main (minimal)"].Skills:FindFirstChild(
            ...
            for i, v in next, game.Players.LocalPlayer.PlayerGui["Main (minimal)"].Skills[
                game:GetService("Players").LocalPlayer.Data.DevilFruit.Value
            ]:GetChildren() do
        ...
        function checkskillSword()
            ...
            if not game.Players.LocalPlayer.PlayerGui["Main (minimal)"].Skills:FindFirstChild(NameSword()) then
                EquipWeaponName(NameSword())
                return false
            end
            for i, v in next, game.Players.LocalPlayer.PlayerGui["Main (minimal)"].Skills[NameSword()]:GetChildren() do
                if v:IsA("Frame") and Config["Use Skills"][v.Name] then
                    if
                        v.Name ~= "Template" and v.Title.TextColor3 == Color3.new(1, 1, 1) and
                            v.Cooldown.Size == UDim2.new(0, 0, 1, -1) or
        ...
        function checkskillGun()
            ...
            if not game.Players.LocalPlayer.PlayerGui["Main (minimal)"].Skills:FindFirstChild(NameGun()) then
                EquipWeaponName(NameGun())
                return false
            end
            for i, v in next, game.Players.LocalPlayer.PlayerGui["Main (minimal)"].Skills[NameGun()]:GetChildren() do
                if v:IsA("Frame") and Config["Use Skills"][v.Name] then
                    if
                        v.Name ~= "Template" and v.Title.TextColor3 == Color3.new(1, 1, 1) and
                            v.Cooldown.Size == UDim2.new(0, 0, 1, -1) or
        ...
        function checkskillMelee()
            if not game.Players.LocalPlayer.PlayerGui["Main (minimal)"].Skills:FindFirstChild(NameMelee()) then
                EquipWeaponName(NameMelee())
                return false
            end
            for i, v in next, game.Players.LocalPlayer.PlayerGui["Main (minimal)"].Skills[NameMelee()]:GetChildren() do
                if v:IsA("Frame") and Config["Use Skills"][v.Name] then
                    if
                        v.Name ~= "Template" and v.Title.TextColor3 == Color3.new(1, 1, 1) and
                            v.Cooldown.Size == UDim2.new(0, 0, 1, -1) or
                    ...
                    for k, v in pairs(huhu) do
                        if k ~= game.JobId and v["Count"] < CountTarget then
                            if not Settings2[k] or tick() - Settings2[k].Time > 60 * 10 then
                                ...
                                SaveSettings2()
                                if
                                game.Players.LocalPlayer.PlayerGui["Main (minimal)"].InCombat.Bottom.Visible and
                                game.Players.LocalPlayer.PlayerGui["Main (minimal)"].InCombat.Visible
                                 then
                                    ...
                                    until not game:GetService("Players").LocalPlayer or
                                        (not game.Players.LocalPlayer.PlayerGui["Main (minimal)"].InCombat.Bottom.Visible and
                                            not game.Players.LocalPlayer.PlayerGui["Main (minimal)"].InCombat.Visible)
                                    AntiLowHealthting = false
                    ...
                    if Config["Farm Type"]["Level"] and (CountType <= 1 or (CountType >= 2 and LocalPlayerLevelValue < 2450)) then
                        if
                         ...
                         then
                            ...
                            if
                            game.Players.LocalPlayer.PlayerGui["Main (minimal)"]:FindFirstChild("Quest").Visible and
                                    namequest and
                                    ...
                                    for i, v in next, game:GetService("Workspace").Characters:GetChildren() do
                                        if v.Name == namequest then
                                            ...
                                            until not v or not v.Parent or v.Humanoid.Health <= 0 or not Config["Farm Normal"] or
                                                not game.Players.LocalPlayer.PlayerGui["Main (minimal)"]:FindFirstChild(
                                                    "Quest"
                                                ).Visible or
